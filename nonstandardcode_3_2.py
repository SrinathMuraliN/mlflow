...
HOUSING_PATH = r'C:\Users\srinath.murali\AppData\Local\Packages\CanonicalGroupLimited.UbuntuonWindows_79rhkp1fndgsc\LocalState\rootfs\home\tiger01476\mle-training\datasets\housing'
...
def train(housing):
    ...
    with mlflow.start_run(run_name='CHILD_RUN', nested=True) as child_run:
        ...
        print("parent run_id: {}".format(parent_run.info.run_id))
        print("child run_id : {}".format(child_run.info.run_id))
        print("Train model function starts")
        ...
        print("lin_rmse is {}".format(lin_rmse))
        ...
        print("tree_rmse is {}".format(tree_rmse))
        ...
        print("final_rmse is {}".format(final_rmse))
